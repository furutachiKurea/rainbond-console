...
from console.services.kubeblocks_integration_service import kubeblocks_integration_service
from console.services.operation_log import operation_log_service, OperationType
from console.views.base import RegionTenantHeaderView
from www.utils.return_message import general_message
from kb_logger import log_ui_request as kb_log_ui_request
...
class KubeBlocksComponentCreateView(RegionTenantHeaderView):
    ...
    def post(self, request, *args, **kwargs):  # pylint: disable=unused-argument
        ...
        """
        # 记录前端 API 请求日志到 kb.log
        kb_log_ui_request(
            api_name="KubeBlocksComponentCreateView.post",
        ...
        try:
            ...
            # 调用集成服务执行完整创建流程
            success, result_data, error_msg = kubeblocks_integration_service.create_complete_kubeblocks_component(
                tenant=self.tenant,
                user=self.user,
